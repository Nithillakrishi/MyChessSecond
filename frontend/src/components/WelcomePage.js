...
const MODE_CARDS = [
  ...
  { id: 'position',  icon: '🎯', color: '#9B59B6', gradient: 'linear-gradient(135deg,rgba(155,89,182,0.18) 0%,rgba(120,60,150,0.08) 100%)', border: 'rgba(155,89,182,0.4)',  title: 'Game Analysis',      desc: 'PGN or FEN. Navigate moves with ChessDB stats + Stockfish.' },
